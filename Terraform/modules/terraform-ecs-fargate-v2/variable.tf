...
variable "placeholder_secrets" {
  description = "Secret place holders created in secret manager (Keys MUST match keys set in secret_key_names)"
  type        = map(string)
  default = {
...
variable "ecs_cluster_name" {
  type        = string
  description = "The name of the required ECS cluster to add service into"
}